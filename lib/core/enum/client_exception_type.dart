enum ClientExceptionType {
  ...
  webCertificateCouldNotBeLoadedError(
      'WEB_CERTIFICATE_COULD_NOT_BE_LOADED_ERROR'),
  ...
  noApplicationFoundToOpenTheFileError(
      'NO_APPLICATION_FOUND_TO_OPEN_THE_FILE_ERROR'),
  deviceDirectoryFetchSizeOperationError(
      'DEVICE_DIRECTORY_FETCH_SIZE_OPERATION_ERROR'),
  deviceDirectoryCreateOperationError(
      'DEVICE_DIRECTORY_CREATE_OPERATION_ERROR'),
  deviceDirectoryDeleteOperationError(
      'DEVICE_DIRECTORY_DELETE_OPERATION_ERROR'),

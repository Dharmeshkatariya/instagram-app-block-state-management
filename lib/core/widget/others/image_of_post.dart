...
import 'package:instagram_dharmesh_bloc_demo/core/widget/others/play_this_video.dart';
import 'package:instagram_dharmesh_bloc_demo/core/widget/others/share_button.dart';
...
import '../../../features/comments/presentation/screen/comments_for_mobile.dart';
import '../../../features/comments/presentation/widgets/comment_box.dart';
import '../../../features/comments/presentation/widgets/comment_of_post.dart';
import '../../../features/notification/domain/entities/notification_check.dart';
import '../../../features/notification/presentation/bloc/notification_cubit.dart';
import '../../../features/timeline/presentation/screen/my_own_time_line/update_post_info.dart';
...
import '../../../features/user/presentation/widgets/bottom_sheet.dart';
...
import '../aimation/like_popup_animation.dart';
...
class _ImageOfPostState extends State<ImageOfPost>
                        ...
                        children: [
                          Container(
                            decoration: const BoxDecoration(
                              border: Border(
                                bottom: BorderSide(
                                    color: AppColors.black38, width: 0.08),
                              ),
                            ),
                            child: Padding(
  ...
  SizedBox buildSizedBox() => SizedBox(
        width: double.infinity,
        height: 50,
        child: Text("Yes", style: getNormalStyle(color: AppColors.black)),
      );
        ...
        Align(
          ...
          child: Opacity(
            ...
            child: LikePopupAnimation(
              ...
              child:
                  const Icon(Icons.favorite, color: AppColors.white, size: 100),
      ...
      children: [
        ...
        Align(
          ...
          child: Icon(
            ...
            color: playTheVideo ? AppColors.transparent : AppColors.white,
  ...
  Widget menuButton() {
    return GestureDetector(
      child: SvgPicture.asset(
        !isThatMobile ? menuHorizontal2Icon : menuHorizontalIcon,
        colorFilter:
            ColorFilter.mode(Theme.of(context).focusColor, BlendMode.srcIn),
        height: 23,
      ),
  ...
  Padding commentButton(BuildContext context, Post postInfoValue) {
    return Padding(
      ...
      child: GestureDetector(
        child: iconsOfImagePost(commentIcon),
        onTap: () {
          if (isThatMobile) {
            Go(context)

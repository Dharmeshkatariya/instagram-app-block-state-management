...
import '../../../features/timeline/presentation/screen/widgets/all_catch_up_icon.dart';
import '../../../features/timeline/presentation/screen/widgets/image_of_post_for_time_line.dart';
import '../../../models/post/post.dart';
import '../../colors/app_colors.dart';
import '../../customPackages/in_view_notifier/in_view_notifier_list.dart';
import '../../customPackages/in_view_notifier/in_view_notifier_widget.dart';
  ...
  Widget columnOfWidgets(
    ...
    return Column(
      ...
      children: [
        ...
        const Divider(color: AppColors.lightGrey, thickness: .15),

...
//           ? OctoPlaceholder.blurHash(widget.blurHash, fit: BoxFit.cover) // Check if blurHash is available
//           : OctoPlaceholder.circularProgressIndicator(), // Use an alternative placeholder if blurHash is unavailable
//     );
//   }
//
//   SizedBox buildError() {
  ...
  Widget buildOcto(height) {
    ...
    return OctoImage(
      ...
      placeholderBuilder: widget.blurHash.isNotEmpty
          ...
          : OctoPlaceholder
              .circularProgressIndicator(), // Use an alternative placeholder
    );
  }

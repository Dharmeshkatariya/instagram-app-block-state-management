...
import '../../../features/story/presentation/screen/story_for_web.dart';
import '../../../features/story/presentation/screen/story_page_for_mobile.dart';
...
class _CircleAvatarOfProfileImageState extends State<CircleAvatarOfProfileImage>
  ...
  final SharedPreferences _sharePrefs = locator<SharedPreferences>();
  Color topColor = AppColors.purple;
  Color middleColor = AppColors.red;

  Color bottomColor = AppColors.lightYellow;

...
import '../../../../features/timeline/presentation/screen/widgets/animated_dialog.dart';
      ...
      if (isLiked) {
        ...
        setState(() {
          loveStatusAnimation.value = const FadeAnimation(
              child: Icon(Icons.favorite, color: AppColors.white, size: 100));
        ...
        children: [
          ...
          SizedBox(
            ...
            child: SvgPicture.asset(
              widget.isThatProfile ? commentIcon : profileIcon,
              height: 28,

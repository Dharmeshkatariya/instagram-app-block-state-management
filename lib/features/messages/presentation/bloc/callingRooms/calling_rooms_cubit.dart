...
import '../../../domain/use_cases/calling_rooms/cancel_joining_to_room.dart';
import '../../../domain/use_cases/calling_rooms/create_calling_room.dart';
import '../../../domain/use_cases/calling_rooms/delete_the_room.dart';
import '../../../domain/use_cases/calling_rooms/get_users_info_in_room.dart';
import '../../../domain/use_cases/calling_rooms/join_to_calling_room.dart';
...
class CallingRoomsCubit extends Cubit<CallingRoomsState> {
  ...
  Future<void> getUsersInfoInThisRoom({required String channelId}) async {
    emit(CallingRoomsLoading());
    await locator
        .call<GetUsersInfoInRoomUseCase>()

        // await _getUsersInfoInRoomUseCase
  ...
  Future<void> leaveTheRoom({
    ...
    emit(CallingRoomsLoading());
    await locator
        .call<CancelJoiningToRoomUseCase>()

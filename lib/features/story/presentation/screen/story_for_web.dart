...
import '../../../../core/customPackages/story_view/story_controller.dart';
import '../../../../core/customPackages/story_view/story_view.dart';
import '../../../../core/customPackages/story_view/utils.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const InstagramLogo(
            color: AppColors.white, enableOnTapForWeb: true),

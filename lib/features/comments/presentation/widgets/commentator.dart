...
import '../../../user/presentation/screen/users_who_likes_for_web.dart';
import '../../../user/presentation/widgets/which_profile_page.dart';
import '../bloc/commentsInfo/cubit/comment_likes/comment_likes_cubit.dart';
import '../bloc/commentsInfo/cubit/repliesInfo/replyLikes/reply_likes_cubit.dart';
          ...
          children: <TextSpan>[
            ...
            if (widget.isThatReply)
              TextSpan(
                ...
                style: getNormalStyle(color: AppColors.lightBlue),

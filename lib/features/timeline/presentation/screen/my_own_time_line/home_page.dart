...
import '../widgets/all_catch_up_icon.dart';
import '../widgets/image_of_post_for_time_line.dart';
import '../widgets/welcome_cards.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Divider divider() {
    return const Divider(color: AppColors.lightGrey, thickness: .15);
  }
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppColors.lowOpacityGrey, width: 1),
        ),
        child: child,
      ),
    );

...
import 'package:instagram_dharmesh_bloc_demo/core/style_resource/custom_textstyle.dart';
import 'package:instagram_dharmesh_bloc_demo/core/utils/toast_show.dart';
...
class _ProfilePageState extends State<PersonalProfilePage> {
  ...
  ValueListenableBuilder<bool> bottomSheetHeadIcon() {
    return ValueListenableBuilder(
        ...
        builder: (context, bool themeValue, child) {
          Color themeOfApp = themeValue ? AppColors.white : AppColors.black;
  ...
  Divider customDivider() =>
      const Divider(indent: 40, endIndent: 15, color: AppColors.grey);
  ...
  List<Widget> widgetsAboveTapBarsForWeb(UserPersonalInfo userInfo) {
    return [
      ...
      const SizedBox(width: 10),
      GestureDetector(
        child: const Icon(Icons.settings_rounded, color: AppColors.black),
      ),
    ];
  }
  ...
  Widget createNewLive() {
    return InkWell(
      ...
      child: createSizedBox(StringsManager.live.tr,
          nameOfPath: instagramHighlightStoryIcon),
    );
  }
  ...
  Widget createStory() {
    return InkWell(
        ...
        child: createSizedBox(StringsManager.story.tr,
            nameOfPath: addInstagramStoryIcon));
  }
  ...
  Widget createVideo() {
    return InkWell(
        ...
        child: createSizedBox(StringsManager.reel.tr, nameOfPath: videoIcon));
  }
